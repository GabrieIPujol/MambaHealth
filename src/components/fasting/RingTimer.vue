...
<style scoped>
.ring-wrap   { display: flex; justify-content: center; position: relative; margin: 8px 0 20px; }
...
.ring-sub { font-size: .72rem; color: var(--text-dim); margin-top: 4px; letter-spacing: .5px; }
</style>
